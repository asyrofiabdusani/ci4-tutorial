...
<?php endif; ?>
<form method="post" action="insertemployee/insert_data" enctype="multipart/form-data">
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <img class="col-sm-2 img-review border-0">
        <div class="col-sm-8">
            <input type="file" class="form-control" name="image" required id="image" value="<?= old('image'); ?>"
...
<script src="/js/img_review.js"></script>
<?= $this->endSection(); ?>